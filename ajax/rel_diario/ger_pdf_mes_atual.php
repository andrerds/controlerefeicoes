...
define('DB','rdsin098_babyeat');
define('USER','rdsin098_babyeat');
...
$pdf->SetY($y_axis);
$pdf->SetX(15);
$pdf->Cell(180,$row_height, utf8_decode('Relatório de Totais - Mês Atual '),1,0,'C',1);
...
$pdf->Cell(100,$row_height,'Data',1,0,'C',1);
$pdf->Cell(30,$row_height,utf8_decode('Mês'),1,0,'C',1);
$y_axis = $y_axis + $row_height;
...
$pdf->Cell(100,$row_height,date('d-m-Y', $timestamp),1,0,'C',0);
$pdf->Cell(30,$row_height,$mes,1,1,'C',0);
...
$pdf->Cell(30,$row_height,utf8_decode('Mês'),1,0,'C',1);
$y_axis = $y_axis + $row_height;
$y = 59; // AQUI EU COLOCO O Y INICIAL DOS DADOS   // SE ULTRAPASSADO, É ADICIONADO UMA PÁGINA  
