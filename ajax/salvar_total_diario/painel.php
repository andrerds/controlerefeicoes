...
switch ($acao) {
   ...
   endforeach;
    ...
    <div class="ui-field-contain">
     ...
     <input type="hidden" name="mes"  value="<?php echo $data_mes; ?>">
   	 <input type="hidden" name="ano" id="text-15" value="<?php echo $ano; ?>">
      ...
      <?php
		...
		?>
               ...
               <!--td ><?php// echo $adm -> 	id; ?></th-->
                ...
                <td align="center"><?php echo $adm -> tml; ?></td>
               	<td><?php echo $adm -> mes; ?></td>
				<td><?php echo $adm -> data; ?></td>
				<td><?php echo $adm -> ano; ?></td>
                <!--td><?php //echo date('d/m/Y', $timestamp); ?></td-->
                <td><button type="submit" id="b_e_tml" data-id="<?php echo $adm->id; ?>"  class="btn btn-warning btn-sm"><span class="minia-icon-pencil-2"></span> Editar</button>
					<button type="submit" id="b_d_tml" data-id="<?php echo $adm->id; ?>"  class="btn btn-danger btn-sm"><span class="minia-icon-trashcan"></span> Excluir</button>
</td>
    </tr>
 			<?php
			endforeach;
	 ...
	 <input type="hidden" name="id" value="<?php echo $dados->id; ?>" />
           ...
           <p class="pull-right">
            <button type="submit" class="btn btn-info">Editar</button>
             <img src="img/loaging.gif" class="load" alt="Carregando" style="display: none" />
             </p>
            </form>
      <?php
      break;
