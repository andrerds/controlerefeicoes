 ...
 <div class="modal-footer">
      ...
      <?php
		...
		?>
 				...
 				<img src="https://graph.facebook.com/<?php echo $adm -> facebook; ?>/picture?type=square" alt="Matheus" class="img-rounded" width="100" height="100"></td>
  ...
  <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    ...
    <input data-clear-btn="true" data-mini="true" name="idade" id="text-15" value="<?php echo $dados->idade; ?>" type="text">
     ...
     <div class="ui-field-contain">
    	...
    	<input type="image" src="https://graph.facebook.com/<?php echo $dados->facebook ?>/picture?type=square" alt="Matheus" class="img-rounded" width="150" height="150" />
      </div>
     <div class="ui-field-contain">
