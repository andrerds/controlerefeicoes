...
//$sql = "select * from total_ml";  
    ...
    // SOMENTE AS FUNÇÕES QUE ESTÃO DENTRO DESTE EXTENDS É QUE SERÃO SUBSTITUIDAS.  
        ...
        function Header(){ //CABECALHO  
           ...
           // $this->Image('baby.jpg',11,11,40); // INSERE UMA LOGOMARCA NO PONTO X = 11, Y = 11, E DE TAMANHO 40.  
    ...
    $sql = "select * from total_ml"; //SELECAO DOS DADOS QUE IRÃO PRO PDF  
    ...
    $pdf->Output("baby.pdf"); // IMPRIME O PDF NA TELA  
