...
switch ($acao) {
 ...
 <?php
    $pdo2 = conecta2();
   $preparar = $pdo2->query("SELECT SUM(tml) total FROM total_ml where mes= '$data_mes' ");
   ...
   ?>
    <div class="ui-field-contain">
         ...
         <input type="text" name="total" id="text-15" value="<?php echo $tml?>">
    </div>
    <?php
   endforeach;
    ?>
...
// case formulario editar
        ...
        <form action="" name="form_edit" method="post">
     	<label>Veja se esta correto !</label>
    ...
    <div class="ui-field-contain">
     ...
     <input data-role="date" data-clear-btn="true" data-mini="true" name="data" id="text-15" value="<?php echo $dados->data; ?>" type="hidden">
    </div> 
      <div class="ui-field-contain">
     
    
     <input data-role="date" data-clear-btn="true" data-mini="true" name="ano" id="text-15" value="<?php echo $dados->ano; ?>" type="hidden">
    </div> 
