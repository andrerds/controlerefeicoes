...
$(document).ready(function() {
	...
	janela.click(function() {
		$.post('http://houseon.ddns.net/app/ajax/editar_perfil/painel_edit_perfil.php', {
			acao : 'form_cad'
		}, function(retorno) {
			$('#myModal').modal({
				backdrop : 'static'
	...
	$("#myModal").on("submit", 'form[name="form_cad"]', function() {
		...
		$.ajax({
			url : 'http://houseon.ddns.net/app/ajax/editar_perfil/controller.php',
			type : 'POST',
			...
			success : function(retorno) {
				...
				if (retorno === 'cadastrou') {
					form.fadeOut('slow', function() {
						...
						listar('http://houseon.ddns.net/app/ajax/editar_perfil/painel.php', 'listar',true);
					});
				} else {
	...
	$('table').on("click", '#btn_edit_perfil', function() {
		var id = $(this).attr('data-id');
			$.post('http://houseon.ddns.net/app/ajax/editar_perfil/painel.php', {
			acao : 'form_edit',
			id : id
		}, function(retorno) {
			$('#myModal').modal({
	...
	$('table').on("click", '#btn_del', function(){
		...
		$.post('http://houseon.ddns.net/app/ajax/editar_perfil/controller.php', {acao: 'excluir', id: id}, function(retorno){
			if(retorno === 'deletou'){
	...
	listar('http://houseon.ddns.net/app/ajax/editar_perfil/painel.php', 'listar'); 
	//___
