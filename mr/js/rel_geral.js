...
$(document).ready(function() {
	...
	janela.click(function() {
		$.post('http://houseon.ddns.net/app/ajax/rel_geral/painel.php',{
			acao : 'form_cad'
		}, function(retorno) {
			$('#myModal').modal({
				backdrop : 'static'
	...
	$("#myModal").on("submit", 'form[name="form_cad"]', function() {
		...
		$.ajax({
			url : 'http://houseon.ddns.net/app/ajax/rel_geral/controller.php',
			type : 'POST',
			...
			success : function(retorno) {
				...
				if (retorno === 'cadastrou') {
					form.fadeOut('slow', function() {
						...
						listar('http://houseon.ddns.net/app/ajax/rel_geral/painel.php', 'listar',true);
					});
				} else {
	...
	$('table').on("click", '#b_d_tml_d', function(){
		...
		$.post('http://houseon.ddns.net/app/ajax/rel_geral/controller.php', {acao: 'excluir', id: id}, function(retorno){
			if(retorno === 'deletou'){
	...
	listar('http://houseon.ddns.net/app/ajax/rel_geral/painel.php', 'listar'); 
	//___
